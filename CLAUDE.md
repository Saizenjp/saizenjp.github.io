...
/ **일행별예약 신규 컬럼 T/U/V**(2026-06 양식 변경: T=고객등급(회원권/일반고객)·U=회원구분(정회원…)·V=회원권구분(EWRCⅡ·다이아몬드… 실제 등급). §13의 「고객등급→회원권구분 대체」가 실제 도착. step1 passengers 파싱이 T(member_grade)+V(실제 등급)를 흡수하도록 반영 필요).

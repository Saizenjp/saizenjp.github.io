...
```
saizenjp.github.io/
├─ index.html              ← 허브 랜딩 (모든 모듈 진입 관문)
├─ app/
│  └─ index.html           ← v13.4 통합 시스템 (인쇄물: 네임택·항공커버·청구서 등)
├─ assets/
│  └─ logo-saizen-*.svg    ← 로고 3종 (양쪽 공유)
...
- **배포**: GitHub Pages 사용 → `https://saizenjp.github.io/hub/room.html`
- **로컬 테스트**: 폴더에서 `python -m http.server 8000` → `http://localhost:8000/hub/room.html`
...
`https://saizenjp.github.io/` 로 허브 랜딩이 열립니다.

...
;(function (root, factory) {
  ...
  var ACCOM_LABEL = {
    ...
    '호텔':           { ja: 'やまなみホテル',   ko: '야마나미 호텔',  en: 'Yamanami Hotel' },   // 표시 라벨만 (키 '호텔'은 불변 — Min 2026-08)
  ...
  //  카트 1대 정원 = 4명(2인승은 2명).
  //  ⚠ 오타·애매 표기는 확정으로 보지 않고 화면의 「재확인 필요」로 뺀다(Min 2026-08).
  //    ※다만 「전기카드 1개 신청 / 2인용으로 사용예정」처럼 문맥이 명백한 오타는 확정으로
  //      인정해도 무방하다고 본다(카트→카드 오타 외 해석이 없음). 규칙을 넓히려면 여기 한 줄.

...
(function (global) {
  ...
  var I18N = {
    ja: {
      ...
      ix_cRoomStatsCd: r('会員','かいいん')+'がどの'+r('客室','きゃくしつ')+r('等級','とうきゅう')+'に'+r('割当','わりあて')+'られたか（'+r('予約月','よやくづき')+r('別','べつ')+'）',
    ...
    ko: {
      ...
      ix_cRoomStatsCd: '회원이 어느 객실등급에 배정됐는지(예약월별) · 디럭스 0회 회원',
      ix_cKeyslipH: '룸키 라벨',
    ...
    en: {
      ...
      ix_cRoomStatsCd: 'Which room grade members ended up in, by booking month · members with no deluxe',

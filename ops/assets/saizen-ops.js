...
(function (global) {
  ...
  var I18N = {
    ja: {
      ...
      ix_cWatchCd: r('全','ぜん')+r('予約','よやく')+'を'+r('本人','ほんにん')+'('+r('氏名','しめい')+'+'+r('生年','せいねん')+')'+r('基準','きじゅん')+'でスキャンし、'+r('長期','ちょうき')+r('滞在','たいざい')+'・'+r('連続','れんぞく')+r('予約','よやく')+'の'+r('連結','れんけつ')+'など'+r('抜','ぬ')+'け'+r('道','みち')+'を'+r('検出','けんしゅつ')+'。マスター'+r('専用','せんよう')+'。',
    ...
    ko: {
      ...
      ix_cWatch: '특이 예약 감시',
      ix_cWatchCd: '전체 예약을 본인(이름+생년) 기준으로 스캔해 장기 체류·연속 예약 연결(체이닝) 등 편법 패턴을 검출합니다. 마스터 전용.',
    ...
    en: {
      ...
      ix_cWatchCd: 'Scan all bookings by person (name+birth) to detect loophole patterns like long stays and consecutive-booking chaining. Master only.',

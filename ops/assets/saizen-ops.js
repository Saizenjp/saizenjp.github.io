...
(function (global) {
  ...
  var I18N = {
    ja: {
      ...
      po_qrScan:'📷 QR'+r('読取','よみとり'), po_qrTitle:'お'+r('客様','きゃくさま')+'の'+r('注文','ちゅうもん')+'QRを'+r('読取','よみとり'), po_qrManualPh:'QR'+r('読取','よみとり')+'できない'+r('時','とき')+'はタグコード'+r('入力','にゅうりょく')+'(例 DJマ-Y)', po_qrManualGo:r('検索','けんさく'),
    ...
    ko: {
      ...
      po_qrScan:'📷 QR 스캔', po_qrTitle:'손님 주문 QR 스캔', po_qrManualPh:'QR 안 될 때 태그코드 입력 (예: DJマ-Y)', po_qrManualGo:'검색',
      po_active: '주문중',
      po_secTeam: '팀',
      po_secMember: '일행',
      po_checkin: '체크인',
    ...
    en: {
      ...
      po_qrScan:'📷 Scan QR', po_qrTitle:'Scan guest order QR', po_qrManualPh:'If QR fails, enter tag code (e.g. DJマ-Y)', po_qrManualGo:'Find',
      po_active: 'ordering',
      po_secTeam: 'Teams',

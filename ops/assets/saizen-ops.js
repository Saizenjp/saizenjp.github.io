...
(function (global) {
  ...
  var I18N = {
    ja: {
      ...
      ix_posRestCd: '飲食・コンベンションホールの注文をチームのご精算に · 厨房分は厨房へ · バー/フロント品目もこの画面で',
    ...
    ko: {
      ...
      ix_posRestCd: '식음·컨벤션 홀 주문을 팀 계산에 · 주방행은 주방으로 · 바/프론트 품목도 이 화면에서',
      ix_posFront: '프론트 POS',

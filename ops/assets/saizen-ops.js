...
(function (global) {
  ...
  var SO_HELP = {
    ...
    'course.html': '<h4>이 화면이 하는 일</h4>그날 라운딩하는 팀을 <b>조 단위</b>로 <b>코스(아소·소보·쿠주)</b>와 <b>티오프 시각</b>에 배정하고, <b>조편성(누가 어느 조인지)까지 같은 화면</b>에서 합니다.<h4>티오프 규칙</h4>코스마다 첫 조 <b>6:50</b>, <b>7분 간격</b>, 마지막 조 <b>8:42</b> = 코스당 17조. 3코스가 같은 시간대에 동시 출발하므로 하루 최대 51조입니다.<h4>홀수(자동)</h4>평일 체류일 <b>27H(18+9 서비스)</b> · 주말·일본 공휴일 <b>18H</b> · 귀국일 부산편 <b>9H</b> · 입국일 ICN팀 <b>18H</b>.<h4>쓰는 법</h4><ul><li>월(◀▶)·라운딩 날짜 선택. 오늘이 있으면 오늘이 자동 선택됩니다.</li><li><b>🪄 자동 배정</b> = 팀을 4인 이하 조로 나눠 코스를 <b>로테이션</b>(같은 팀이 여러 날이면 아소→소보→쿠주)으로 채웁니다.</li><li><b>쿠주힐즈 숙박 팀은 늦은 조</b>(「늦게」 뱃지)로 뒤에서부터 채웁니다 — 16:30~17:00 종료 → 샤워 → 18시 식사 → 송영이 이어지게.</li><li>조를 클릭해 선택 → <b>빈 칸을 클릭</b>하면 그 코스·시각으로 옮깁니다. 조의 <b>✕</b>는 배정 해제.</li><li><b>미배정 팀</b>을 클릭하면 빈 자리에 자동으로 넣습니다.</li><li><b>제외</b> = 그날 라운딩 안 하는 팀을 뺍니다(자동 배정에서도 빠지고, 이미 잡힌 조도 내려갑니다). 아래 <b>제외한 팀</b>에서 <b>↩ 복귀</b>. 성수기엔 규칙대로면 조가 51개(코스당 17×3)를 넘으므로 이걸로 조절합니다.</li><li><b>≡ 드래그</b> = 조를 자유롭게 옮깁니다. 빈 칸에 놓으면 이동, <b>찬 칸에 놓으면 그 자리에 끼워넣고</b> 아래를 한 칸씩 밉니다(맨 아래까지 차 있으면 서로 바꿉니다). 시간대 중간에 다른 팀을 넣을 때 씁니다.</li><li><b>조 편성(사람 배치)도 이 화면에서</b> — 조를 클릭하면 위 <b>조 편성</b> 패널이 열립니다. 그 팀의 미배정 인원을 눌러 넣고, 넣은 사람을 다시 누르면 뺍니다. <b>남·여</b> 버튼으로 성별 몰아넣기, <b>이름 검색</b>으로 다른 팀 사람도 넣을 수 있습니다(합동 조).</li><li><b>💾 저장</b> → 그날의 코스·티오프·조원을 함께 저장합니다. 남아 있는 조는 <b>id를 유지</b>합니다.</li><li><b>🖨 미리보기</b> = A4 가로 코스 배정표(화면과 같은 배열).</li></ul><h4>권한·데이터</h4>golf 영역. bookings·guests·guest_members·passengers 읽기 / golf_groups 쓰기.',

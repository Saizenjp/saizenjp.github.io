...
(function (global) {
  ...
  var I18N = {
    ja: {
      ...
      ix_cCourseCd: r('組','くみ')+r('単位','たんい')+'で'+r('阿蘇','あそ')+'·'+r('祖母','そぼ')+'·'+r('久住','くじゅう')+'と'+r('ティ','')+r('時刻','じこく')+'（6:50〜8:42・7'+r('分','ふん')+r('間隔','かんかく')+'）を'+r('割当','わりあて')+'。'+r('自動','じどう')+r('配分','はいぶん')+'·A4'+r('横','よこ')+r('印刷','いんさつ'),
    ...
    ko: {
      ...
      ix_cCourseH: '코스 배정표',
      ix_cCourseCd: '조 단위로 아소·소보·쿠주와 티오프(6:50~8:42·7분 간격) 배정. 자동 배분·A4 가로 인쇄',
      ix_cGolfH: '골프 조편성',
    ...
    en: {
      ...
      ix_cCourseCd: 'Assign courses (Aso·Sobo·Kuju) and tee times (6:50–8:42, 7-min) by group. Auto-balance, A4 landscape print',

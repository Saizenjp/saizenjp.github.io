...
(function (global) {
  ...
  var I18N = {
    ja: {
      ...
      ix_dSettle: '精算', ix_dSettleDesc: '現場精算(チェックアウト)・B2B月次精算',
    ...
    ko: {
      ...
      ix_dSettle: '정산', ix_dSettleDesc: '현장 정산(체크아웃) · B2B 월 정산',
      ix_dPartner: '제휴 숙소',
    ...
    en: {
      ...
      ix_dSettle: 'Billing', ix_dSettleDesc: 'On-site checkout billing · monthly B2B settlement',

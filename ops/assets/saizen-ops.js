...
(function (global) {
  ...
  var I18N = {
    ja: {
      ...
      ix_g1Desc: r('予約','よやく')+'ファイル4'+r('種','しゅ')+r('登録','とうろく'),
      ix_c1Step: 'STEP 1',
      ix_c1H: r('データ','')+r('登録','とうろく'),
      ix_c1Cd: r('予約','よやく')+'リスト・'+r('同行者','どうこうしゃ')+r('別','べつ')+r('予約','よやく')+'・'+r('現地','げんち')+r('到着','とうちゃく')+'・グループコードの4'+r('つ','')+'のファイルをアップロードすると、'+r('自動','じどう')+'で'+r('整理','せいり')+'・'+r('保存','ほぞん')+'されます。'+r('同','おな')+'じファイルを'+r('再','さい')+'アップロードしても'+r('重複','じゅうふく')+'しません。',
      ...
      s1_lead: r('予約','よやく')+r('関連','かんれん')+'の4つのファイルを'+r('順番','じゅんばん')+'にアップロードすると、'+r('自動','じどう')+'で'+r('整理','せいり')+'・'+r('保存','ほぞん')+'されます。'+r('同','おな')+'じファイルを'+r('誤','あやま')+'って'+r('再','さい')+'アップロードしても'+r('重複','じゅうふく')+'しないので'+r('安心','あんしん')+'です。<b>'+r('アップロード','')+r('順','じゅん')+'</b>：'+r('予約','よやく')+'リスト → '+r('同行者','どうこうしゃ')+r('別','べつ')+r('予約','よやく')+' → '+r('現地','げんち')+r('到着','とうちゃく')+' → グループコード。',
    ...
    ko: {
      ...
      ix_g1H: '데이터 준비',
      ix_g1Desc: '예약 파일 4종 등록',
      ix_c1Step: 'STEP 1',
      ix_c1H: '데이터 등록',
      ix_c1Cd: '예약리스트·일행별예약·현지도착·그룹코드 4개 파일을 올리면 자동으로 정리되어 저장됩니다. 같은 파일을 다시 올려도 중복되지 않습니다.',
      ix_g2H: '현장 운영',
      ...
      s1_sub: '엠클릭 예약 파일 등록',
      s1_lead: '예약 관련 4개 파일을 순서대로 올리면 자동으로 정리되어 저장됩니다. 같은 파일을 실수로 다시 올려도 중복되지 않으니 안심하세요. <b>올리는 순서</b>: 예약리스트 → 일행별예약 → 현지도착 → 그룹코드.',
      s1_h2conn: '① 데이터베이스 연결',
      s1_lblUrl: 'Project URL',
      s1_lblKey: 'anon key',

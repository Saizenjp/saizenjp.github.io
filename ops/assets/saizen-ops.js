...
(function (global) {
  ...
  var I18N = {
    ja: {
      ...
      st_taxHint: r('消費税','しょうひぜい')+'10%'+r('別','べつ')+' · '+r('通貨','つうか')+'：'+r('円','えん')+'(JPY)',
    ...
    en: {
      ...
      st_taxHint: 'Consumption tax 10% added · Currency: JPY',
      st_colFolios: 'Folios',

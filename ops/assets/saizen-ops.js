...
(function (global) {
  ...
  var I18N = {
    ja: {
      ...
      ix_c1Sh: '予約データ登録',
      ix_c2Sh: '到着〜出発の客室割当',
      ix_c5Sh: '追加料金の集計・御請求書',
      ix_c7Sh: '厨房の調理リスト',
      ix_c8Sh: '品目・価格・提供元',
      ix_cAdminSh: 'アカウント権限・担当範囲',
      ix_cAircoverSh: 'チーム別 航空案内カード',
      ix_cAuditSh: '印刷前のデータ点検',
      ix_cBoardSh: '部署のお知らせ・本日要約',
      ix_cCartSh: 'カートの保有・割当',
      ix_cCourseSh: 'コース・ティ・組編成',
      ix_cDinnerSh: '夕食名簿・食数',
      ix_cDispatchSh: 'イベント別 手配書',
      ix_cFrontSh: 'チェックイン/アウト・入金',
      ix_cGroupSh: '会員グループコード',
      ix_cHkSh: '階ごとの清掃割当・進捗',
      ix_cInvFnbSh: '食材・飲料・厨房',
      ix_cInvRoomSh: '客室備品・アメニティ',
      ix_cInvHkSh: 'リネン・清掃用品',
      ix_cInvGolfSh: 'カート部品・ゴルフ用品',
      ix_cInvFrontSh: '事務用品・印刷用紙',
      ix_cInvShizuSh: '志津の宿 備品',
      ix_cKeyslipSh: 'ルームキー ラベル',
      ix_cNametagSh: '個人ネームタグ',
      ix_cNoticeSh: '現場の案内文',
      ix_cOccupSh: '日別の使用・空き客室',
      ix_cPosCustSh: 'お客様前のご精算表示',
      ix_cQrCardsSh: 'チーム別 注文QRカード',
      ix_cRoomStatsSh: '会員の客室グレード',
      ix_cSettleMeritSh: '宿泊・送迎の月次精算',
      ix_cShizuSh: '志津の宿 予約表',
      ix_cStatsSh: '入込・売上・稼働率',
      ix_cTransferSh: '便ごとの送迎',
      ix_cVisitorSh: '来場人数の集計',
      ix_cWatchSh: '予約形態の点検',
      ix_kdsBarSh: '厨房＋バー 統合画面',
      ix_posFrontSh: 'フロント物販・追加料金',
      ix_posGolfSh: '物品販売',
      ix_posRestSh: '飲食・宴会の注文',
      ix_goEnter: r('入','はい')+'る',
      ix_cFrontH: 'フロントデスク',
      ...
      ix_cQrCardsH: r('注文','ちゅうもん')+'QR'+r('カード',''), ix_cQrCardsCd: 'お客様にお渡しするチーム別 注文QRカードの印刷',
    ...
    ko: {
      ...
      ix_c1Sh: '예약 자료 등록',
      ix_c2Sh: '도착~퇴실 객실 배정',
      ix_c5Sh: '추가 요금 집계 · 御請求書',
      ix_c7Sh: '주방 조리 목록',
      ix_c8Sh: '품목 · 가격 · 나가는 곳',
      ix_cAdminSh: '계정 역할 · 담당 범위',
      ix_cAircoverSh: '팀별 항공 안내 카드',
      ix_cAuditSh: '인쇄 전 데이터 점검',
      ix_cBoardSh: '부서 공지 · 오늘 요약',
      ix_cCartSh: '카트 보유 · 배정',
      ix_cCourseSh: '코스 · 티오프 · 조편성',
      ix_cDinnerSh: '석식 명단 · 식수',
      ix_cDispatchSh: '행사별 수배서',
      ix_cFrontSh: '체크인·아웃 · 결제 · 영수증',
      ix_cGroupSh: '회원 그룹코드',
      ix_cHkSh: '층별 청소 배정 · 진행',
      ix_cInvFnbSh: '식자재 · 음료 · 주방',
      ix_cInvRoomSh: '객실 비품 · 어메니티',
      ix_cInvHkSh: '린넨 · 청소용품',
      ix_cInvGolfSh: '카트 부품 · 골프 용품',
      ix_cInvFrontSh: '사무용품 · 인쇄용지',
      ix_cInvShizuSh: '시즈노야도 비품',
      ix_cKeyslipSh: '룸키 라벨',
      ix_cNametagSh: '개인 네임택',
      ix_cNoticeSh: '현장 안내문',
      ix_cOccupSh: '날짜별 사용 · 여유 객실',
      ix_cPosCustSh: '손님 앞 계산 내역',
      ix_cQrCardsSh: '팀별 주문 QR카드',
      ix_cRoomStatsSh: '회원 객실 등급 현황',
      ix_cSettleMeritSh: '숙박 · 송영 월 정산',
      ix_cShizuSh: '시즈노야도 예약표',
      ix_cStatsSh: '입도 · 매출 · 가동률',
      ix_cTransferSh: '항공편별 픽업 · 샌딩',
      ix_cVisitorSh: '방문 인원 집계',
      ix_cWatchSh: '예약 형태 점검',
      ix_kdsBarSh: '주방 + 바 통합 화면',
      ix_posFrontSh: '프론트 판매 · 추가 요금',
      ix_posGolfSh: '물품 판매',
      ix_posRestSh: '식음 · 연회 주문',
      ix_goEnter: '들어가기',
      ix_cFrontH: '프론트 데스크',
      ...
      ix_cQrCardsH: '주문 QR카드', ix_cQrCardsCd: '손님에게 드릴 팀별 주문 QR카드 인쇄',
    ...
    en: {
      ...
      ix_c1Sh: 'Register booking data',
      ix_c2Sh: 'Rooms for the whole stay',
      ix_c5Sh: 'On-site extras & invoice',
      ix_c7Sh: 'Kitchen order list',
      ix_c8Sh: 'Items, prices, outlet',
      ix_cAdminSh: 'Account roles & areas',
      ix_cAircoverSh: 'Flight cards by team',
      ix_cAuditSh: 'Data check before printing',
      ix_cBoardSh: 'Notices & today’s summary',
      ix_cCartSh: 'Cart stock & assignment',
      ix_cCourseSh: 'Course, tee times, groups',
      ix_cDinnerSh: 'Dinner list & meal counts',
      ix_cDispatchSh: 'Arrangement sheet',
      ix_cFrontSh: 'Check-in/out, payments',
      ix_cGroupSh: 'Member group codes',
      ix_cHkSh: 'Cleaning by floor & progress',
      ix_cInvFnbSh: 'Food, drinks, kitchen',
      ix_cInvRoomSh: 'Room supplies & amenities',
      ix_cInvHkSh: 'Linen & cleaning supplies',
      ix_cInvGolfSh: 'Cart parts & golf goods',
      ix_cInvFrontSh: 'Office & printing supplies',
      ix_cInvShizuSh: 'Shizu supplies',
      ix_cKeyslipSh: 'Room key slips',
      ix_cNametagSh: 'Guest name tags',
      ix_cNoticeSh: 'On-site notices',
      ix_cOccupSh: 'Rooms used & free by date',
      ix_cPosCustSh: 'Bill shown to the guest',
      ix_cQrCardsSh: 'Order QR cards by team',
      ix_cRoomStatsSh: 'Member room grades',
      ix_cSettleMeritSh: 'Monthly B2B settlement',
      ix_cShizuSh: 'Shizu room chart',
      ix_cStatsSh: 'Visitors, revenue, occupancy',
      ix_cTransferSh: 'Pickups & drop-offs by flight',
      ix_cVisitorSh: 'Visitor counts',
      ix_cWatchSh: 'Booking policy review',
      ix_kdsBarSh: 'Kitchen + bar view',
      ix_posFrontSh: 'Front retail & extras',
      ix_posGolfSh: 'Retail sales',
      ix_posRestSh: 'Dining & banquet orders',
      ix_goEnter: 'Enter',
      ...
      ix_cQrCardsH: 'Order QR cards', ix_cQrCardsCd: 'Print the order QR card handed to each team',

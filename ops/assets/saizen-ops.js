...
(function (global) {
  ...
  var I18N = {
    ja: {
      ...
      ix_cSignageLobbyH: r('案内','あんない')+'モニター · ロビー', ix_cSignageLobbyCd: 'ロビーのテレビに 歓迎板・ご出発案内(便・ホテル出発時刻)・夕食・天気・お知らせ を順に表示。お知らせは部署掲示板で「モニターにも表示」',
    ...
    ko: {
      ...
      ix_cSignageLobbyH: '안내 모니터 · 로비', ix_cSignageLobbyCd: '로비 TV에 환영판·출발 안내(항공편·호텔 출발시각)·석식·날씨·공지를 차례로 표시. 공지는 부서 보드에서 「모니터에도 표시」',
    ...
    en: {
      ...
      ix_cSignageLobbyH: 'Signage · Lobby', ix_cSignageLobbyCd: 'Lobby TV rotation: welcome board, departures (flight, hotel departure time), dinner, weather, notices. Mark notices “show on monitor” on the board',

...
(function (global) {
  ...
  var I18N = {
    ja: {
      ...
      ix_cSignageH: r('案内','あんない')+'モニター', ix_cSignageCd: 'ロビー・2Fのテレビに「本日の夕食」を全画面表示（会場・時間・チーム）。会場は夕食オーダー画面で指定',
    ...
    ko: {
      ...
      ix_cSignageH: '안내 모니터', ix_cSignageCd: '로비·2층 TV에 「오늘 석식」 전체화면 (장소·시간·팀). 장소는 석식 오더 화면에서 지정',
    ...
    en: {
      ...
      ix_cSignageH: 'Signage monitor', ix_cSignageCd: 'Full-screen “tonight’s dinner” for lobby / 2F TVs (venue, time, teams). Set the venue on the Dinner Order page',

...
(function (global) {
  ...
  var SO_HELP = {
    ...
    'transfer.html': '<h4>이 화면이 하는 일</h4>그날 <b>공항 픽업(도착)</b>·<b>샌딩(출발)</b> 하는 팀을 <b>항공편별</b>로 묶어 현장에서 <b>태블릿으로 점검</b>합니다. 태블릿이 없는 날은 같은 내용을 <b>인쇄</b>해서 씁니다.<h4>화면이 두 가지입니다</h4><ul><li><b>🚌 기사용</b> — 便별 운행표. <b>이름은 안 나옵니다.</b> 팀 코드·인원·행선지(숙소)·편명·구간·시각만 보고, 팀마다 <b>[승차 완료]</b> 를 누릅니다.</li><li><b>🙋 미팅·샌딩용</b> — 손님을 맞이하러 가는 담당자용. 팀별 <b>이름 명단</b>이 나오고 <b>사람마다 눌러</b> 확인합니다. <b>[팀 전원]</b> 으로 한 번에 켜고 끌 수 있습니다.</li></ul>체크는 <b>바로 저장</b>되고(누가 언제 눌렀는지 기록) 다른 태블릿·PC 에서도 같은 상태가 보입니다. 편 머리줄의 숫자가 <b>진행률</b>(확인 / 전체)입니다.<h4>인쇄물 2종</h4>보고 있는 화면에 따라 인쇄 버튼이 바뀝니다 — <b>기사용 운행표</b>(확인 네모칸·실인원·소계·담당자/차량/출발시각 기입칸) / <b>미팅 명단표</b>(팀별 이름 + □ 체크칸).<h4>줄이 나뉘는 규칙</h4>같은 팀이라도 <b>인천·부산이 섞이면 편별로 줄이 나뉘고</b> 인원을 따로 셉니다(명단의 개인별 항공정보 기준). 명단이 아직 없는 팀은 <b>예약 인원</b>으로 한 줄 나옵니다(편명·시각 빈칸).<h4>화면 조작</h4>날짜(◀ ▶ · 오늘) · 구분(전체·도착·출발) · 숙소 필터. 일본어 화면에서는 이름이 <b>가타카나</b>로 나옵니다.<h4>권한·데이터</h4>print 또는 front 영역. bookings·guests·passengers·guest_members 읽기 / transfer_checks 읽기·쓰기(SQL 110).',

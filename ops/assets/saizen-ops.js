...
(function (global) {
  ...
  var I18N = {
    ja: {
      ...
      ix_cInvHkH: '清掃・リネン在庫',
      ix_cInvHkCd: 'リネン・清掃用品・洗剤・備品の数量管理',
      ix_cInvGolfH: 'ゴルフ・カート在庫',
      ix_cInvGolfCd: 'カート部品・コース資材・ゴルフ用品の数量管理',
      ix_cInvFrontH: 'フロント・事務在庫',
      ix_cInvFrontCd: '事務用品・印刷用紙・販促物の数量管理',
      ix_cInvShizuH: '志津の宿 在庫',
      ix_cInvShizuCd: '志津の宿の備品・アメニティ・リネンの数量管理',
    ...
    ko: {
      ...
      ix_cInvHkH: '청소 · 린넨 재고',
      ix_cInvHkCd: '린넨·청소용품·세제·비품 수량 관리',
      ix_cInvGolfH: '골프 · 카트 재고',
      ix_cInvGolfCd: '카트 부품·코스 자재·골프용품 수량 관리',
      ix_cInvFrontH: '프론트 · 사무 재고',
      ix_cInvFrontCd: '사무용품·인쇄용지·판촉물 수량 관리',
      ix_cInvShizuH: '시즈노야도 재고',
      ix_cInvShizuCd: '시즈노야도 비품·어메니티·린넨 수량 관리',
    ...
    en: {
      ...
      ix_cInvHkCd: 'Linen, cleaning supplies, detergents and sundries',
      ix_cInvGolfH: 'Golf · cart inventory',
      ix_cInvGolfCd: 'Cart parts, course materials and golf supplies',
      ix_cInvFrontH: 'Front · office inventory',
      ix_cInvFrontCd: 'Office supplies, printing paper and promotional items',
      ix_cInvShizuH: 'Shizu inventory',
      ix_cInvShizuCd: 'Supplies, amenities and linen for Shizu-no-yado',

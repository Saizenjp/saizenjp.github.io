...
(function (global) {
  ...
  var SO_HELP = {
    ...
    'cart.html': '<h4>이 화면이 하는 일</h4><b>날짜별 카트 종합 관리표</b>입니다. 보유·사용·잔여 대수와 팀별 배정(코스·티오프 포함)을 한 화면에서 봅니다.<h4>나오는 팀</h4>그 날 <b>라운딩하는 팀</b>만 나옵니다 — <b>입국일=인천팀만 · 귀국일=부산팀만 · 체류 중=전원</b>(인천팀은 귀국일에 라운딩이 없어 자동으로 빠집니다).<h4>전기카트 사전신청 자격</h4><b>야마나미 리조트 골프클럽을 이용하는 날에만</b> 유료 사전신청이 됩니다. 야마나미리조트·쿠주힐즈·시즈노야도 료칸은 <b>항상 가능</b>(골프는 모두 야마나미CC), <b>간지호텔은 평일이 구주고원CC</b>라 <b>야마나미CC를 쓰는 날(주말·공휴일·입국일)만</b> 가능합니다 — 표에 「야마나미CC일만」으로 표시됩니다. <b>현장 신청</b>은 자격과 무관하게 언제나 가능하니 신청구분을 「현장」으로 두면 됩니다.<h4>사용법</h4><ul><li>상단 <b>보유 대수</b>는 그 자리에서 고칠 수 있습니다(전기카트 36대가 기본값). 종류별 <b>사용·잔여</b>가 아래 표와 실시간 연동되고, 보유를 넘으면 경고가 뜹니다.</li><li>팀 행에서 <b>종류별 대수·신청구분(사전/현장)·카트번호·메모</b>를 입력하고 <b>💾 변경 저장</b>. 대수를 0으로 두면 그 배정은 삭제됩니다.</li><li><b>코스·티오프</b>는 골프 조편성에서 저장한 값을 읽어옵니다(미편성이면 빈칸). 코스 칸의 큰 글씨는 <b>규칙상 코스</b>입니다.</li><li>요금은 <b>1대 1일 ¥2,000</b>(종류별로 수정 가능)이며 행별·전체 합계가 자동 계산됩니다. <b>🖨 인쇄</b>=A4 가로.</li></ul><h4>권한·데이터</h4>golf 영역(읽기는 로그인 전체). cart_types·cart_bookings 읽기·쓰기 / bookings·guests·passengers·golf_groups 읽기. ⚠ <code>93_cart.sql</code> 실행 필요.',

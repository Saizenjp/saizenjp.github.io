...
(function (global) {
  ...
  var SO_HELP = {
    ...
    'admin.html': '<h4>이 화면이 하는 일</h4>계정 <b>역할·영역 지정</b> + 가입요청 처리. <b>마스터 전용</b>.<h4>계산·판정</h4><ul><li>역할 <b>admin / manager / staff</b> + 영역(step1·room·settle·pos·kitchen·menu·notes·<b>stats</b>).</li><li>admin·manager=전 카드 통과, staff=<b>지정 영역만</b>. <b>경영 통계(stats)는 예외</b> — admin 또는 stats 지정자만(매니저 자동통과 X).</li></ul><h4>권한·데이터</h4>admin 전용. user_access·access_requests.',

...
(function (global) {
  ...
  var I18N = {
    ja: {
      ...
      ix_c6Cd: 'レストラン・コンベンションホール・ゴルフショップで、'+r('係員','かかりいん')+'がタブレットでメニューをタップし'+r('該当','がいとう')+'チームに'+r('直接','ちょくせつ')+r('注文','ちゅうもん')+'を'+r('付','つ')+'けます。'+r('合計','ごうけい')+'は'+r('精算','せいさん')+r('口座','こうざ')+'に'+r('自動','じどう')+'で'+r('反映','はんえい')+'。',
    ...
    ko: {
      ...
      ix_c6Cd: '레스토랑·컨벤션 홀·골프샵에서 직원이 태블릿으로 메뉴를 탭해 해당 팀에 바로 주문을 답니다. 합계는 정산 계정에 자동 반영됩니다.',
      ix_c7H: '주방 화면 (KDS)',

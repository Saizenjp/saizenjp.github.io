...
(function (global) {
  ...
  var I18N = {
    ja: {
      ...
      po_teamSearch: r('グループ','')+'コード・'+r('代表者','だいひょうしゃ')+'・'+r('行事','ぎょうじ')+r('番号','ばんごう')+'で'+r('検索','けんさく'),
    ...
    ko: {
      ...
      po_teamSearch: '그룹코드·대표자·행사번호로 검색',
      po_active: '주문중',
      po_secTeam: '팀',
      po_secMember: '일행',
      po_checkin: '체크인',
    ...
    en: {
      ...
      po_teamSearch: 'Search by group code, rep, or event no.',
      po_active: 'ordering',
      po_secTeam: 'Teams',

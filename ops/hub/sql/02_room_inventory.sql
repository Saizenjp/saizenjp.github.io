...
insert into room_inventory (facility, zone, room_no, room_type, capacity, max_capacity, active, note, sort_order) values
  ...
  -- 시즈노야도 료칸 — 본관 4 + 별채 3 (정원2·최대3, 1인 4,400엔/박)
  ('시즈노야도 료칸','본관','본관 1호','트윈',2,3,true,null,60),
  ('시즈노야도 료칸','본관','본관 2호','트윈',2,3,true,null,61),
  ('시즈노야도 료칸','본관','본관 3호','트윈',2,3,true,null,62),
  ('시즈노야도 료칸','본관','본관 4호','트윈',2,3,true,null,63),
  ('시즈노야도 료칸','별채','별채 1호','트윈',2,3,true,'개인온천(물 채울 시 추가비용)',64),
  ('시즈노야도 료칸','별채','별채 2호','트윈',2,3,true,'개인온천(물 채울 시 추가비용)',65),
  ('시즈노야도 료칸','별채','별채 3호','트윈',2,3,true,'개인온천(물 채울 시 추가비용)',66)

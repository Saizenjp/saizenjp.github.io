-- ============================================================================
--  SaiZen Hub — 정산·POS·주방·메뉴 통합 실행 SQL (09+10+11+12 한 번에)
-- ----------------------------------------------------------------------------
--  이 파일 하나만 SQL Editor에 붙여넣고 Run 하면 정산·POS·KDS·메뉴가 전부 준비됩니다.
--  모두 멱등(여러 번 실행해도 안전). 기존 01~08(예약·방배정)이 먼저 있어야 합니다.
--  실행 후 00_VERIFY.sql 로 설치 상태를 확인하세요.
-- ============================================================================
...
-- ============================================================================
--  SaiZen Hub — 10 간이 POS 메뉴 마스터 (menu_items)
-- ----------------------------------------------------------------------------
...
--     주방 티켓·다단말 동시편집 같은 본격 기능이 필요해지면 그때 11_ 로 도입.
--
